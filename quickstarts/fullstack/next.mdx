...
Once you've [initialized your Next app](https://nextjs.org/docs/app/getting-started/installation) , installing [hanko-elements](/guides/hanko-elements/introduction) provides you with access to the prebuilt components: `hanko-auth` and `hanko-profile`.

During this quickstart, ensure that you add the code for the correct NextJS Router.\
Either the [App Router](https://nextjs.org/docs/app) or the [Pages Router](https://nextjs.org/docs/pages), depending on your setup.
...
To do this create a file HankoAuth.tsx and insert the code below.\
For this QuickStart we will create it at `components/HankoAuth.tsx`
...
After you created the `HankoAuth` component, simply import it into any page.\
Just like this.
...
The `<hanko-profile>` component provides an interface where users can manage their `Password` , `Email Addresses`, `Passkeys`, `Security Keys` and `Sessions`.

To do this create a file called HankoProfile.jsx and insert the code below.\
For this QuickStart we will create it at `components/HankoProfile.jsx`
...
To do this create a file LogoutButton.tsx and insert the code below.\
For this QuickStart we will create it at `components/LogoutButton.tsx`
